    ...
    if request.method == 'POST':
        ...
        if form_cliente.is_valid():
            ...
            if form_endereco.is_valid():
                ...
                cliente_novo = cliente.Cliente(nome=nome, sobrenome=sobrenome, sexo=sexo, data_nascimento=data_nascimento, email=email, profissao=profissao, endereco=endereco_bd)
    ...
    if form_cliente.is_valid():
        ...
        if form_endereco.is_valid():
            ...
            if cliente_antigo.endereco == None:
                ...
                cliente_novo = cliente.Cliente(nome=nome, sobrenome=sobrenome, sexo=sexo, data_nascimento=data_nascimento, email=email, profissao=profissao, endereco=cliente_antigo.endereco)
